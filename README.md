...
- [STRATA-Bench](https://github.com/movahedi-ca/strata-bench) `🌱` `[Python]` `[Benchmark]` - 36-task benchmark for AI agents on fragmented spatial-temporal market intelligence; scores honesty about gaps.
