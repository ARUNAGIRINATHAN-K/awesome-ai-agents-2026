...
- [Awesome Agentic Commerce](https://github.com/MentionNetwork/awesome-agentic-commerce) `🌱` `[Multi-Agent]` - Curated list for agents that shop, sell and transact: commerce protocols (UCP, ACP, AP2, MCP), commerce MCP servers and agent readiness tools.
