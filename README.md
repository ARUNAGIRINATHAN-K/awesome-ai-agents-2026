...
- [Hivekeep](https://github.com/MarlBurroW/hivekeep) `🔬` `[TypeScript]` `[Multi-Agent]` - Self-hosted platform running a team of specialized agents that collaborate, share memory, and build their own tools.
