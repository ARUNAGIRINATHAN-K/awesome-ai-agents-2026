...
- [cv.cm Drama Agent](https://cv.cm/v/agent) - Turns a one-sentence idea into a short drama by auto-writing the concept and generating its images and video (🏷️ `Cloud` `Freemium` `Web`).
