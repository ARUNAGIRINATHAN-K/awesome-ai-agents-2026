...
- [PerspectiveGap](https://github.com/WhymustIhaveaname/PerspectiveGap) `🔬` `[Python]` `[Benchmark]` - Benchmark for multi-agent orchestration prompt writing across 110 scenarios and 10 topologies.
