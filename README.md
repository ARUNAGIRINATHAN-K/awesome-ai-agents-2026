...
-  [Hermes](https://www.buildwithhermes.com) - White-label voice agent platform for agencies with native CRM, campaign orchestration, and transparent usage billing. (🏷️ `Cloud` `Agency` `Platform`).
