...
- [GTD Brain](https://gtdbrain.com/connect?source=awesome-ai-agents-2026) `🔬` `[Cloud]` `[MCP]` - Hosted MCP server with OAuth 2.1 and 16 tools that lets ChatGPT, Claude, Gemini CLI and Cursor run a Getting Things Done board.
